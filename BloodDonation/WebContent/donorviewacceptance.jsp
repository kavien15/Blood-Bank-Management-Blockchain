...
<body>
        ...
        <div class="main-content">
            ...
            <div class="search-section">
                <div class="search-box">
                    ...
                    <input type="text" id="searchInput" placeholder="Search by patient name, doctor, hospital, or blood group...">
                </div>
            ...
            <div class="table-container">
                ...
                try {
                    ...
                    String sql = "SELECT * FROM patients WHERE status='accepted'";
                ...
                <table id="requestsTable">
                    ...
                    <tbody>
                        ...
                        while(rs.next()) {
                            requestCount++;
                        %>
                        <tr data-name="<%= rs.getString("p_name").toLowerCase() %>" 
                            data-hospital="<%= rs.getString("h_addres") %>" 
                            data-bloodgroup="<%= rs.getString("p_bgp") %>"
                            data-doctor="<%= rs.getString("h_name").toLowerCase() %>">
                            <td>
                                <div class="patient-name"><%= rs.getString("p_name") %></div>
                                <div class="patient-email"><%= rs.getString("p_mail") %></div>
                                <div class="patient-mobile"><%= rs.getString("p_mobile") %></div>
                            </td>
                            <td>
                                <span class="blood-group"><%= rs.getString("p_bgp") %></span>
                            </td>
                            <td>
                                <div class="doctor-name"><%= rs.getString("h_name") %></div>
                            </td>
                            <td>
                                <div class="doctor-details"><%= rs.getString("d_number") %></div>
                            </td>
                            <td><%= rs.getString("h_addres") %></td>
                            <td>
                                <span class="status-badge status-accepted">
                                    <i class="fas fa-check"></i> <%= rs.getString("status") %>
                                </span>
                            </td>
                        </tr>
                        <%
    ...
    <script>
        ...
        function updateStatistics(totalCount) {
            ...
            const doctorCells = document.querySelectorAll('td:nth-child(3)');
            const hospitalCells = document.querySelectorAll('td:nth-child(5)');
            
            doctorCells.forEach(cell => {
                const doctorName = cell.querySelector('.doctor-name').textContent.trim();
        ...
        function setupSearchAndFilters() {
            ...
            let visibleCount = tableRows.length;
