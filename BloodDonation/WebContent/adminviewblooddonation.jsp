...
<body>
    ...
    <div class="header">
        <div class="header-content">
            <h1><i class="fas fa-users"></i> Donation Records</h1>
            <p>Blood Donation Records & Management System</p>
    ...
    <div class="table-container" id="tableContainer">
        <table>
            <caption>Blood Donation Details</caption>
            <thead>
                <tr>
                    <th>Patient Name</th>
                    <th>Hospital</th>
            ...
            <tbody id="userTableBody">
                ...
                PreparedStatement ps = con.prepareStatement("SELECT * FROM `blood`.`donatedetails`");
                ...
                <tr class="user-row" 
                    ...
                    data-email="<%= rs.getString(2).toLowerCase() %>"
                    data-phone="<%= rs.getString(3).toLowerCase() %>"
                    ...
                    <td data-label="Age">
                        <i class="fas fa-tint" style="color: var(--primary-red); margin-right: 5px;"></i>
                        <%= rs.getString(4) %>
                    </td>
                    ...
                    <td data-label="Location">
                        <i class="fas fa-calendar-alt" style="color: var(--primary-red); margin-right: 5px;"></i>
                        <%= rs.getString(8) %>
                    </td>
