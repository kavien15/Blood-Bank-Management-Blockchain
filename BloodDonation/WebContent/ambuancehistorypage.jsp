...
<header>
    <div class="logo">
        ...
        <h1>Ambulance Life Saving Records</h1>
    </div>
...
<%
    ...
    PreparedStatement ps = con.prepareStatement("SELECT * FROM patient WHERE location=? AND status=? AND ambstatus=? AND ambulanceno=? ORDER BY id DESC");
    ps.setString(1, location);
    ps.setString(2, "Allocate");
    ps.setString(3, "Accepted");
    ps.setString(4, ambno);
...
<div class="dashboard">
    <div class="dashboard-header">
        <h2>Ambulance Life Saving History</h2>
        ...
        <table id="requestsTable">
            ...
            <tr>
                ...
                <td>
                 ...
                 <td>
                    <span class="status status-<%= r[7].toLowerCase() %>">
                        <%= r[7] %>
                    </span>
                </td>
